...
3. **BLOCK_N_PLAN.md** for the current block — locked design decisions. Block 9 next (post Block 6 ff-merge); BLOCK_9_PLAN.md to be drafted in a fresh plan-mode session per the most recent HANDOFF section.
